...
class WarrantyExchangeWorkflowController extends Controller
{
    ...
    public function approve(Request $r, SolarWarrantyClaim $claim): RedirectResponse
    {
    ...
    public function requestInfo(Request $r, SolarWarrantyClaim $claim): RedirectResponse
    {
    ...
    public function reject(Request $r, SolarWarrantyClaim $claim): RedirectResponse
    {
    ...
    public function resubmit(Request $r, SolarWarrantyClaim $claim): RedirectResponse
    {
        $d = $r->validate([
    ...
    public function reopen(Request $r, SolarWarrantyClaim $claim): RedirectResponse
    {
    ...
    // ---- Kho
    public function reserve(Request $r, SolarWarrantyClaim $claim): RedirectResponse
    {
        $d = $r->validate([
    ...
    public function release(Request $r, SolarWarrantyClaim $claim): RedirectResponse
    {
        $d = $r->validate(['reason' => ['required', 'string', 'max:5000']]);
    ...
    public function issue(Request $r, SolarWarrantyClaim $claim): RedirectResponse
    {
    ...
    public function faultyReturn(Request $r, SolarWarrantyClaim $claim): RedirectResponse
    {
        $d = $r->validate([
            'warehouse_id' => ['required', 'integer', 'exists:crm_warehouses,id'],
    ...
    // ---- Kỹ thuật
    public function techReceive(Request $r, SolarWarrantyClaim $claim): RedirectResponse
    {
        $d = $r->validate([
    ...
    public function confirmReplaced(Request $r, SolarWarrantyClaim $claim): RedirectResponse
    {
        $d = $r->validate([
    ...
    public function deferReturn(Request $r, SolarWarrantyClaim $claim): RedirectResponse
    {
        $d = $r->validate(['reason' => ['required', 'string', 'max:5000']]);
    ...
    private function run(SolarWarrantyClaim $claim, string $ok, callable $fn): RedirectResponse
    {
