...
<nav id="sidebar" class="ego-sidebar" aria-label="Main sidebar">
    ...
    <div class="ego-sidebar__scroll">
        <ul class="ego-nav" role="list">
            ...
            {{-- CÔNG TRÌNH --}}
            @hasanyrole('ky_thuat|accounting|warehouse|kho|admin')
...
@else
    ...
    <li class="ego-item ego-item--has-sub" data-title="Sản phẩm" data-ego-sub="true">
        <a href="#menuSP"
           class="ego-link {{ active_route(['products.input','products.output','products.history','products.create','categories.*','warehouses.*','brands.*','price-tiers.*','company-management.*']) }}"
           data-bs-toggle="collapse"
           data-ego-type="toggle"
           aria-expanded="{{ request()->routeIs('products.input') || request()->routeIs('products.output') || request()->routeIs('products.history') || request()->routeIs('products.create') || request()->routeIs('categories.*') || request()->routeIs('warehouses.*') || request()->routeIs('brands.*') || request()->routeIs('price-tiers.*') || request()->is('company-management*') ? 'true' : 'false' }}"
        ...
        <ul id="menuSP"
            class="ego-sub collapse {{ (request()->routeIs('products.input') || request()->routeIs('products.output') || request()->routeIs('products.history') || request()->routeIs('products.create') || request()->routeIs('categories.*') || request()->routeIs('warehouses.*') || request()->routeIs('brands.*') || request()->routeIs('price-tiers.*') || request()->is('company-management*')) ? 'show' : '' }}"
            data-ego-submenu>
        ...
        <ul id="menuNhanSu"
            ...
            <li class="ego-item ego-item--nested ego-item--has-sub" data-title="Chấm công" data-ego-sub="true">
                <a href="#menuNhanSuChamCong"
                   class="ego-sublink ego-sublink--toggle {{ request()->routeIs('hr.attendance.*') || request()->routeIs('hr.leave.*') ? 'active' : '' }}"
                   data-bs-toggle="collapse"
                   data-ego-type="toggle"
                ...
                <ul id="menuNhanSuChamCong"
                    class="ego-sub ego-sub--nested collapse {{ request()->routeIs('hr.attendance.*') || request()->routeIs('hr.leave.*') ? 'show' : '' }}"
                    data-ego-submenu>
