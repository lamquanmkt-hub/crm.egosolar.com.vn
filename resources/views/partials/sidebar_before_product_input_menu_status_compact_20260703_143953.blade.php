...
@else
    ...
    <li class="ego-item ego-item--has-sub" data-title="Sản phẩm" data-ego-sub="true">
        <a href="#menuSP"
           class="ego-link {{ active_route(['products.input','products.output','products.history','products.serials.*','products.create','categories.*','warehouses.*','brands.*','price-tiers.*','company-management.*']) }}"
           data-bs-toggle="collapse"
           data-ego-type="toggle"
           aria-expanded="{{ request()->routeIs('products.input') || request()->routeIs('products.output') || request()->routeIs('products.history') || request()->routeIs('products.serials.*') || request()->routeIs('products.create') || request()->routeIs('categories.*') || request()->routeIs('warehouses.*') || request()->routeIs('brands.*') || request()->routeIs('price-tiers.*') || request()->is('company-management*') ? 'true' : 'false' }}"
        ...
        <ul id="menuSP"
            class="ego-sub collapse {{ (request()->routeIs('products.input') || request()->routeIs('products.output') || request()->routeIs('products.history') || request()->routeIs('products.serials.*') || request()->routeIs('products.create') || request()->routeIs('categories.*') || request()->routeIs('warehouses.*') || request()->routeIs('brands.*') || request()->routeIs('price-tiers.*') || request()->is('company-management*')) ? 'show' : '' }}"
            data-ego-submenu>
...
@endhasanyrole
    ...
    @auth
        ...
        <div class="ego-sidebar__footer">
            <div class="ego-status-card" aria-label="Trạng thái hôm nay">
                <div class="ego-status-card__glow"></div>

                <div class="ego-status-card__top">
                    <div class="ego-status-card__heading">
                ...
                <!-- EGO_SIDE_LANG_START -->
                <div class="ego-side-lang-box" title="Chuyển ngôn ngữ">
